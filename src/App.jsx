...
function buildSegsFromLegs(legs, fuelType, totalMiles, vehicleRange, bufferMiles, maxDetour) {
...
export default function App() {
  ...
  async function calc(){
    ...
    try {
      ...
      if(route.routeLegs) segs = buildSegsFromLegs(route.routeLegs, vehicle.fuelType, route.totalMiles, practicalRange, prefs.bufferMiles||25, prefs.maxDetour||2);
